...
#cumulative sum
data2 %>% mutate (cumNEE=cumsum(NEEgmhh)) ->data2
data2 %>% mutate (cumLE=cumsum(LEgmhh)) ->data2
data2 %>% mutate (cumGPP=cumsum(GPPgmhh)) ->data2
data2 %>% mutate (cumReco=cumsum(Recogmhh)) ->data2
...
p<-ggplot(data2,aes(x=dt,y=NEE_WithUstar_f))+geom_point()+
...
p + theme_tufte() + geom_rangeframe()+ggtitle("a) Miscanthus")+
  xlab("")+ylab("cumulative ET (mm m-2)")

ggsave("out/OgletreeCumET.pdf",useDingbats=FALSE)

#GPP
p<-ggplot(data2,aes(x=dt,y=cumGPP*.01))+
  geom_point()+
  geom_vline(xintercept=miscanthusHarvestF2015, linetype="dotdash")+
  geom_vline(xintercept=miscanthusHarvestF2016, linetype="dotdash")+
  geom_vline(xintercept=miscanthusHarvestS2016, linetype="dotdash")
...
p + theme_tufte() + geom_rangeframe()+ggtitle("a) Miscanthus")+
  xlab("")+ylab("cumulative GPP (Mg C ha-1)")

ggsave("out/OgletreeCumGPP.pdf",useDingbats=FALSE)

#RECO
p<-ggplot(data2,aes(x=dt,y=cumReco*.01))+
  geom_point()+
  geom_vline(xintercept=miscanthusHarvestF2015, linetype="dotdash")+
  geom_vline(xintercept=miscanthusHarvestF2016, linetype="dotdash")+
  geom_vline(xintercept=miscanthusHarvestS2016, linetype="dotdash")
...
p + theme_tufte() + geom_rangeframe()+ggtitle("a) Miscanthus")+
  xlab("")+ylab("cumulative Reco (Mg C ha-1)")
